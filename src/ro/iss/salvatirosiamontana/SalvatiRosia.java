...
//	}
	...
	protected void onResume() {
		...
		for (String subscr : subscriptions) {
			if ("Romana".equalsIgnoreCase(subscr) || "International".equalsIgnoreCase(subscr)||"Diaspora".equalsIgnoreCase(subscr)){
	...
	private class CustomWebViewClient extends WebViewClient {
		...
		public void onReceivedError(WebView view, int errorCode,
			...
			UIUtilities.createCommunicationErrorDialog(
					SalvatiRosia.this).show();
		}
